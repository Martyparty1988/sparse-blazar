...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end md:items-center justify-center p-0 md:p-4 animate-fade-in">
      ...
      <div className="relative w-full max-h-[85vh] overflow-y-auto md:max-w-md p-6 md:p-10 bg-slate-900/90 backdrop-blur-2xl rounded-t-[3rem] md:rounded-[3rem] shadow-[0_40px_100px_rgba(0,0,0,0.7)] border-t md:border border-white/20 transform transition-all scale-100 pb-[calc(2rem+env(safe-area-inset-bottom))] md:pb-10">
